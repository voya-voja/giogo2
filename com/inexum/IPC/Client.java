...
//        System.out.println("Executing the function...");  
        ...
        if(returnObject != null && (new Exception()).getClass().isAssignableFrom(returnObject.getClass()))
...
//        System.out.println("The remote function executed OK!");  
    ...
    {
        InetAddress hostAddr = InetAddress.getByName(m_host);
        return(new Socket(hostAddr, m_port));
    }
