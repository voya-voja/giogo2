<%@ page import = "com.giogo.StartGameViewController"%>
...
<title>Gamaxy Game Startup</title>


<% 
        StartGameViewController controller = new StartGameViewController(request);
%>
...
<div align="center">
  <center>
      <p align="center" style="word-spacing: 4"><em><strong><font face="Verdana" size="3" color="#0000FF">Starting 
  a new game!</font></strong></em> 
    </p>
  </center>
</div>
