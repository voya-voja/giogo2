...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" id="AutoNumber1" width="900" >
    ...
    <td width="234" align="center" height="103" valign="top">
        <table>
        	<tr>
        		<td>
		      	&nbsp;<APPLET codebase="./"
                 code="com/giogo/TalkApplet.class" width=223 height=475>
            <PARAM NAME = "name" VALUE ="talk">
            <PARAM NAME = "session.id" VALUE ="<%out.print(controller.session());%>">
        </APPLET></td>
		</tr>
		</table>
